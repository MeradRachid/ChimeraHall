...
{ // On extends Manager pour pouvoir accéder à ses méthodes publiques 
    ...
    protected $className = "Model\Entities\Format"; // arborescence des namespaces
    protected $tableName = "format"; // C'est la table à laquelle on veut accéder.  
    ...
    */
    ...
    public function formatEventCount()
    {
        $sql = 'SELECT COUNT(id_format) AS `FormatEvent` FROM `format`';
